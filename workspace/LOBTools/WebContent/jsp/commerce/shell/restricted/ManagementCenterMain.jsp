...
<%
	...
	if (java.lang.System.getProperty("WorkspaceTaskListEnabled") != null) {
		workspacesEnabled = Boolean.valueOf(java.lang.System.getProperty("WorkspaceTaskListEnabled"));
	} else {
		workspacesEnabled = com.ibm.commerce.tools.common.ToolsConfiguration
				.isComponentEnabled("WorkspaceTaskList");
	}
