...
<wcf:getData
	...
	<wcf:param name="accessProfile" value="IBM_Admin_Minimum" />
...
<c:forEach var="catentry" items="${catentries}">
	...
	<object objectType="CatalogFilterInclude${referenceObjectType}">
		...
		<jsp:directive.include file="/jsp/commerce/catalogfilter/restricted/serialize/SerializeGenericCatalogEntry.jspf"/>
	</object>
	</c:if>
